...
// Avatar image library - avatar.iran.liara.run (1-100)
const AVATAR_BASE = "https://avatar.iran.liara.run/public";
export const AVATAR_LIBRARY = Array.from({ length: 100 }, (_, i) => `${AVATAR_BASE}/${i + 1}.png`);

export function getRandomAvatarFromLibrary() {
  return AVATAR_LIBRARY[Math.floor(Math.random() * AVATAR_LIBRARY.length)];
}
